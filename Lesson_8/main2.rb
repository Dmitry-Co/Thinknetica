...
class Main
  ...
  def find_station
    ...
    # Видит как передачу аргумента. Возможно ли как-то применить похожее выражение взамен расположенного выше?
    gets.chomp
  end

  def create_station
    puts "Введите название для станции по условию:
   1) Не менне 3х символов
  ...
  # метод закомментирован выше без &.
  # def get_station(input)
  #   @stations.select(&:title == input)
  # end
  ...
  def create_train
    ...
    puts 'Задайте номер поезда: комб. 3х англ. букв или чисел, дефис(необяз), комб. 2х англ. букв/чисел.'
