...
class Main
  ...
  def gets_choice
    ...
    if hash_of_action
      ...
      puts 'Цифра из списка не введена, попробуйте еще раз!'
    end
  end
  ...
  def create_station
    puts 'Введите название для станции на англ.языке без цифр: '
    begin
      title = gets.chomp
  ...
  def move_train
    puts 'Какой поезд вы хотите передвинуть?'
